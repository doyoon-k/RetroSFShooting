...
- HP 2, 피격 무적, 출격 무적, LV1~3 기본 공격, 폭탄, 전방 차지 공격·탄환 제거
- 6명의 파일럿, 파괴·콕핏 연출, 생존자 표정, 5초 선택, 강화 아이템 회수
- Power Up / Bomb / Shield, 약한 유도 이동, 경계 반사, 수명
- 45기의 잡몹·일반 적·중형 적, 65초 웨이브 이후 2단계 보스
...
- [에디터 작업 가이드](docs/EDITOR_GUIDE.md): 적 공격 추가, 보스 순서 변경, 경로 그리기, 에셋 교체
